...
import os
from signal_processing.Signal10_gearbox import gearboxx
...
def update_mins_fj_signal_analysis_MED(path, group, machine, component, sensor, file, localfilename, methods):
    db = get_db()
