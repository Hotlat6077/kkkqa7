...
from Signal3_timefrequency import *
from 去滑雪坡特征 import ski_slope


# 三维频谱图 曹学勇修补 
def update_mins_fj_signal_analysis_fft3d_cao_fix(data, fs, methods='raw'):
    # db = get_db()
    # group = int(group)
    # machine = int(machine)
...
if __name__ == '__main__':
    ...
    res = update_mins_fj_signal_analysis_fft3d_cao_fix(data, fs, methods='raw')
    # x轴为result['fea_xaxis'] 
    # y轴为result['fea_y']
