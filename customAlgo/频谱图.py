...
# 曹学勇修补 频谱图 代码
def update_mins_fj_signal_analysis6_cao_fix(data, fs, time, methods='raw'):
    # 转速信号提取 这里取的0 
    speed = 0
...
if __name__ == '__main__':
    ...
    res = update_mins_fj_signal_analysis6_cao_fix(data, fs, time='20251229180100', methods='raw')
    import json
    print(json.dumps(res, default=str))
    from draw2plot import plot_waveform_dual
    plot_waveform_dual(res, 'fea_x', 'fea_y','fea_xaxis', 'log_y',top_label= 'Fea',bottom_label='log_y')
