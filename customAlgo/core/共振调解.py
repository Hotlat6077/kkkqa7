...
#曹学勇修补 共振调解
def update_mins_fj_signal_analysis_resonance_cao_fix(data, fs, filetime, methods='raw'):
    db = get_db()
...
if __name__ == "__main__":
    ...
    print(type(data))
    update_mins_fj_signal_analysis_resonance_cao_fix(data, fs, time=time, methods='raw')