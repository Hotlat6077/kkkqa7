...
import numpy as np
# from preprocess_data import denoisex, frequencyx, ndarray2list0
from datetime import datetime
from frequency_test import theory_frequencies
from Signal6_denoise import denoisex
#  # 这里缺少参数没有完成 gm d gk pu yi j p wh su b klj w yi ji i fk cwq wq 
...
# 曹学勇修补
def update_mins_fj_signal_analysis_waveletd_cao_fix(data, fs , filetime,methods='raw'):
    ...
    # permissions_collection = db['permissions']  # 假设权限设置存储在名为 'permissions' 的集合中
    permissions_collection = {}  # 假设权限设置存储在名为 'permissions' 的集合中
...
if __name__ == '__main__':
    ...
    update_mins_fj_signal_analysis_waveletd_cao_fix(data, fs, filetime='20251229180100', methods='raw')